...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?= \Yii::$app->urlManager->createUrl(['admin/index/demo'])?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2016-2019 <a href="http://www.zi-han.net/" target="_blank">君意集团</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
